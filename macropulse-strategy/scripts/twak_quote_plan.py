...
def build_plan(strategy: dict[str, Any], notional_usdc: float) -> str:
    ...
    lines = [
        ...
        "",
        "Runtime surfaces:",
        "- Trust Wallet Agent SDK CLI: npx @trustwallet/cli --version",
        "- Trust Wallet MCP/REST can be used by an agent runtime after user-controlled authentication.",
        "- MacroPulse only emits quote and alert intent; it never signs.",
        "",
        "Safety model:",
